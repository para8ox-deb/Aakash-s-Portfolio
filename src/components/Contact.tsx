  ...
  return (
    <article className="bg-gray-800 rounded-lg p-6">
      ...
      <div className="space-y-6">
        {/* Email */}
        <div className="flex items-center gap-4 bg-gray-900/50 p-4 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300">
      ...
      {/* Call-to-Action */}
      <h4 className="text-2xl font-bold text-center mt-12 text-gray-300">
        Let’s Connect!
      </h4>
