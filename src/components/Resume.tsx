export default function Resume() {
  return (
    <article className="bg-gray-800 rounded-lg p-6">
      ...
      {/* Education Section */}
      <div className="mb-12">
        <h3 className="text-2xl font-semibold text-amber-500 mb-6">Education</h3>
        
        <div className="space-y-8">
          <div>
            <h4 className="text-xl font-semibold ">Vellore Institute of Technology, Chennai</h4>
          ...
          <div>
            <h4 className="text-xl font-semibold ">St. Anselm’s Sr. Sec. School, Alwar</h4>
      ...
      {/* Skills Section */}
      <div>
        <h3 className="text-2xl font-semibold text-amber-500 mb-8">Skills</h3>

        {/* First row of skill cards */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div className="bg-gray-900/50 p-6 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300">
      ...
      <div className="mt-8 text-center">
        <a 
          ...
          className="inline-block px-6 py-3 bg-amber-500 text-black font-semibold rounded-lg hover:bg-amber-600 transition-all duration-300"
        >
          Download Resume
        </a>
      </div>
