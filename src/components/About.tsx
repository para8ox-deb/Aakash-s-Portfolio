export default function About() {
  return (
    <article className="bg-gray-800 rounded-lg p-6">
      <h2 className="text-3xl font-bold mb-6 pb-2 border-b border-gray-700 text-amber-500">
        About Me
      </h2>
      ...
      <h3 className="text-2xl font-bold mt-12 mb-6 text-amber-500">What I Do</h3>

      <div className="grid md:grid-cols-2 gap-6">
        <div className="bg-gray-900/50 p-6 rounded-lg shadow-lg shadow-gray-900/50 hover:shadow-xl hover:shadow-gray-900/60 transition-all duration-300">
